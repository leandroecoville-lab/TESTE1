...
# ================================================
# EXECUTAR_FABRICA_TEAM_SAFE_V012
# ================================================
#
# Objetivo:
...
#
# Uso:
#   MODULE=lai-connect LAI_ACTOR_ID=leandro ./runbooks/EXECUTAR_FABRICA_TEAM_SAFE_V012.sh
#
# Modules:
...
TRACE="${TRACE:-V012_$(date +%Y%m%d_%H%M%S)}"
OUT="${OUT:-./_out}"
TMP="${TMP:-./_tmp}"
...
echo "[V012] trace=$TRACE module=$MODULE"
